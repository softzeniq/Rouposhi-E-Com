  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          { label: 'Total Revenue', value: `${totalRevenue.toLocaleString()} AED` },
          { label: 'Avg Order Value', value: `${avgOrderValue.toFixed(1)} AED` },
        ...
        <div className="space-y-3">
          {topProducts.length === 0 ? (
            ...
            <div key={p.name} className="flex items-center justify-between py-2 border-b border-border last:border-0">
              ...
              <span className="font-body text-sm font-bold text-primary">{p.revenue} AED</span>
            </div>
          ))}
        </div>
      </div>
