    ...
    <div className="min-h-screen bg-[#FDFDFD] text-gray-900 font-body">
      ...
      <div className="pb-16">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-1/2 flex justify-center relative min-h-[600px] items-center">
                ...
                <div className="relative w-[280px] h-[580px] bg-white rounded-[3rem] border-[8px] border-black shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden z-10 flex flex-col">
                  ...
                  <div className="pt-10 px-4 pb-4">
                    <div className="flex items-center justify-between mb-5 px-1">
                      ...
                      <div className="flex gap-1.5 items-center text-black">
                        ...
                        <svg
                          ...
                          fill="currentColor"
                        >
                          <path d="M12 3C6.95 3 3.15 4.85 0 7.23L12 22 24 7.23C20.85 4.85 17.05 3 12 3z" />
                        </svg>
                        <div className="w-5 h-3 border-2 border-black rounded-[4px] relative">
                          <div className="absolute right-0.5 top-[1px] bottom-[1px] left-[1px] bg-black rounded-[1px]"></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center gap-2 overflow-hidden px-1">
                      <div className="flex flex-col items-center gap-2">
                        <div className="w-10 h-10 bg-[#F5F5F5] rounded-full flex items-center justify-center overflow-hidden">
                          <img
                            src="https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&q=80&w=100"
                            alt="Interior"
                      ...
                      <div className="flex flex-col items-center gap-2">
                        <div className="w-10 h-10 bg-amber-50 rounded-full flex items-center justify-center overflow-hidden border border-yellow-200/50 shadow-inner">
                          <img
                        ...
                        <span className="text-[7px] font-bold text-[#FF4B4B]">
                          Technology
                        </span>
                      </div>
                      <div className="flex flex-col items-center gap-2">
                        <div className="w-10 h-10 bg-[#F5F5F5] rounded-full flex items-center justify-center overflow-hidden">
                          <img
                            src="https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&q=80&w=100"
                            alt="Lighting"
                            className="w-full h-full object-cover opacity-90"
                          />
                        </div>
                      ...
                      <div className="flex flex-col items-center gap-2">
                        <div className="w-10 h-10 bg-[#F5F5F5] rounded-full flex items-center justify-center overflow-hidden">
                          <img
                            src="https://images.unsplash.com/photo-1617196034183-421b4917c92d?auto=format&fit=crop&q=80&w=100"
                            alt="Dishes"
                            className="w-full h-full object-cover opacity-90"
                          />
                        </div>
                  ...
                  <div className="flex-1 bg-white px-4 grid grid-cols-2 gap-x-3 gap-y-4 overflow-hidden pt-2">
                    ...
                    <div className="flex flex-col">
                      <div className="w-full aspect-square bg-[#F4F4F4] rounded-[1.2rem] mb-2.5 flex items-center justify-center overflow-hidden">
                        <img
                          src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&q=80&w=200"
                          alt="Product 1"
                          className="w-full h-full object-cover mix-blend-multiply"
                        />
                      </div>
                      <p className="text-[10px] font-extrabold text-[#111] leading-tight">
                        $82.00
                      </p>
                    ...
                    <div className="flex flex-col relative">
                      <div className="absolute top-2 right-2 bg-[#4ADE80] text-[#111] text-[6px] font-extrabold px-1.5 py-0.5 rounded-sm z-10 tracking-wide">
                        15%
                      </div>
                      <div className="w-full aspect-square bg-[#F4F4F4] rounded-[1.2rem] mb-2.5 flex items-center justify-center p-3">
                        <img
                          src="https://images.unsplash.com/photo-1546868871-7041f2a55e12?auto=format&fit=crop&q=80&w=200"
                          alt="Product 2"
                      ...
                      <p className="text-[10px] font-extrabold text-[#111] leading-tight">
                        $85.00{" "}
                        <span className="line-through text-gray-300 ml-1 font-semibold text-[8px]">
                          $100.00
                        </span>
                      </p>
                      <p className="text-[8px] font-semibold text-gray-400 mt-0.5">
                    ...
                    <div className="flex flex-col">
                      <div className="w-full aspect-square bg-[#F4F4F4] rounded-[1.2rem] mb-2.5 flex items-center justify-center overflow-hidden">
                        <img
                          src="https://images.unsplash.com/photo-1585386959984-a4155224a1ad?auto=format&fit=crop&q=80&w=200"
                          alt="Product 4"
                ...
                <div className="absolute left-0 md:left-4 top-20 bg-white p-4 rounded-[1.2rem] shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-gray-100 flex gap-4 animate-[pulse_5s_ease-in-out_infinite] z-20">
                  <div>
                    ...
                    <div className="bg-gray-100 text-gray-500 text-[8px] font-bold px-2 py-1 rounded-full w-fit mb-3">
                      Last 6 months
                    </div>
              ...
              <div className="w-full lg:w-1/2 space-y-10">
                <div className="space-y-4">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#111]">
          ...
          <div className="grid lg:grid-cols-2 gap-x-12 gap-y-16">
            ...
            <div className="space-y-6 flex flex-col justify-center">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-gray-400 leading-snug">
                Refined aesthetics{" "}
                <span className="text-[#111]">Premium apparel</span>{" "}
                High-quality furniture{" "}
                <span className="text-[#111]">Lifestyle retail.</span>
              </h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 h-[220px] md:h-[280px]">
              <div className="bg-gray-100 rounded-[2rem] overflow-hidden relative shadow-sm">
                ...
                <div className="absolute top-4 right-4 flex gap-2">
                  <span className="bg-[#111] text-white text-[10px] px-3 py-1.5 rounded-full font-bold uppercase tracking-wider">
                    Apparel
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col justify-center space-y-10 pl-0 lg:pl-6">
              <p className="text-gray-500 leading-relaxed text-lg">
                Legacy-29 was born out of a passion for refined aesthetics and
                entrepreneurship. We set out with a clear vision: to bridge the
                gap between high-end sophistication and everyday accessibility.
                Today, our brand spans multiple carefully curated sectors,
                including premium fashion apparel, lifestyle retail through
                Legacy-29 Mart, and high-quality home furnishings under Legacy
                Furniture.
              </p>

              <div className="grid grid-cols-3 gap-6 border-b border-gray-100 pb-10">
                <div>
                  <h4 className="text-4xl font-extrabold text-[#111] mb-1">
                    3+
                  </h4>
        ...
        <div className="container mx-auto px-4 lg:px-8 pt-6 lg:pt-16">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-gray-500 leading-relaxed text-lg">
                Operating a seamless e-commerce model means we focus entirely on
                making your shopping experience smooth, fast, and reliable. We
              ...
              <div className="min-h-[160px] pt-4">
                {activeTab === "quality" && (
                  <div className="space-y-4 animate-[fadeIn_0.3s_ease-in-out]">
                    ...
                    <p className="text-gray-500 leading-relaxed">
                      We do not cut corners. From fabric selection in our
                      apparel line to the fine craftsmanship of our furniture,
                      quality is our top priority. Every single product that
                      carries the Legacy-29 name undergoes rigorous quality
                      curation, ensuring it meets the high standards our
                      customers deserve.
                    </p>
                  </div>
                )}
                {activeTab === "customer" && (
                  <div className="space-y-4 animate-[fadeIn_0.3s_ease-in-out]">
                    ...
                    <p className="text-gray-500 leading-relaxed">
                      Operating a seamless dropshipping and e-commerce model
                      means we focus entirely on making your shopping experience
                      smooth, fast, and reliable. Our goal is to redefine
                      premium lifestyle e-commerce in Dubai by placing customer
                ...
                {activeTab === "sophistication" && (
                  <div className="space-y-4 animate-[fadeIn_0.3s_ease-in-out]">
                    ...
                    <p className="text-gray-500 leading-relaxed">
                      We believe in the power of minimalist design. Our products
                      are crafted to look effortless yet undeniably premium.
                      Whether it is our signature t-shirts or our functional
                      living room sets, we bridge the gap between high-end
                      sophistication and everyday accessibility.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="absolute -left-4 md:-left-12 -bottom-8 md:bottom-12 bg-white p-6 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-gray-100 min-w-[220px]">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm font-bold text-[#111]">MD Sagor</p>
                  </div>
                  <p className="text-xs text-gray-500 italic">
                    "Our goal is to redefine premium lifestyle e-commerce in
                    Dubai."
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl text-center mt-6 border-t border-gray-100 pt-20">
          <h3 className="text-3xl font-extrabold text-[#111] mb-6">
            Join the Roupshi Kunj
          </h3>
          <p className="text-lg text-gray-500 leading-relaxed mb-8">
            Whether you are redefining your personal style, upgrading your home,
            or shopping for everyday essentials, Legacy-29 is here to accompany
            you on that journey. Experience the next level of lifestyle retail.
          </p>
          <Link
            to="/shop"
            className="inline-flex items-center gap-3 bg-[#111] text-white px-10 py-4 rounded-xl font-bold tracking-widest uppercase hover:bg-black transition-all shadow-lg hover:-translate-y-1"
          >
