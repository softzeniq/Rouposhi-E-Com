          ...
          >
            ...
            {page?.content ? (
              ...
              <p className="text-lg md:text-xl text-gray-500 leading-relaxed max-w-2xl mx-auto">
                Have a question about our collections? Need assistance with an
                order? Our dedicated team is here to provide you with an
                exceptional premium experience.
              </p>
            )}
          </motion.div>
        </div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-5">
                {s?.contact_email && (
                  <a
                    ...
                    className="flex items-center gap-5 p-5 bg-[#F8F9FA] rounded-[1.2rem] hover:bg-gray-100 transition-colors group"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-5 py-3.5 bg-[#F4F4F4] rounded-xl text-sm text-[#111] font-medium focus:outline-none focus:ring-2 focus:ring-gray-200 transition-all placeholder:text-gray-400"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full px-5 py-3.5 bg-[#F4F4F4] rounded-xl text-sm text-[#111] font-medium focus:outline-none focus:ring-2 focus:ring-gray-200 transition-all resize-none placeholder:text-gray-400"
                  ...
                  <button
                    type="submit"
                    disabled={sending}
                    className="w-full bg-[#111] text-white py-4 rounded-xl font-bold hover:bg-black transition-colors shadow-lg shadow-black/10 flex items-center justify-center gap-2 disabled:opacity-70 mt-2"
                  >
